...
- **Бонус загрузки Opportunity благоприятствует GC** — использование исключительно Galactic Coin является предпочтительным способом использования этого корабля.
- Этот бонус загрузки **похоже, не распространяется на специальные заказы** (на данный момент проводится внутриигровое тестирование), поэтому SO на Opportunity теряет главное преимущество корабля.
...
У Opportunity есть **бонус загрузки**, зависящий от того, сколько груза перевозит корабль во время рейса. На маршрутах с галактическими монетами этот бонус значительно увеличивает выплату — поэтому стандарт гильдии — **только GC, всегда**, чтобы накапливать бонус за нагрузку при каждом заходе.

Специальные заказы на Opportunity — это двойная потеря: вы упускаете бонус загрузки GC на корабле, построенном для него, и **бонус загрузки, похоже, в любом случае не увеличивает награды за специальные заказы**. Отдавайте специальные приказы Дему; оставьте Opportunity на GC.

*Если патч изменит способ взаимодействия бонуса загрузки со специальными заказами, обновите этот документ.*
...
| Ошибка | Исправить |
|---------|-----|
| Специальные заказы на возможности | Переместите все SO в Dem — бонус загрузки Opp предназначен для **GC** и, похоже, не помогает SO |
...
| Корабль | Роль | Узор |
|------|------|---------|
| **Возможность** | Специалист по ГХ | **только** Galactic Coin — **бонус загрузки на GC**; ТАК, похоже, не приносит пользы |
