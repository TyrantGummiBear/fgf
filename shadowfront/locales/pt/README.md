> **Machine translation (pt).** English source: [README.md](../../README.md). Report fixes in guild chat or a GitHub issue.
...
**Pense nisso como o CoD Control.** Cada cofre tem um **círculo de captura**. As frotas dentro do círculo contam - **a maioria dos números vence**, não os navios mais fortes.
...
> **Se você não está no círculo de captura, você não está contestando o ponto.**

Capture é um **jogo de números**. Empilhe o círculo, remova os inimigos dentro dele e mantenha a contagem.
...
*Documento legado completo: [shadowfront-tactics.md](shadowfront-tactics.md)*